...
def get_balance():
try:
url = BASE_URL + “/v3/accounts/” + OANDA_ACCOUNT_ID + “/summary”
...
def get_open_trades():
try:
url = BASE_URL + “/v3/accounts/” + OANDA_ACCOUNT_ID + “/openTrades”
r = requests.get(url, headers=HEADERS, timeout=10)
...
try:
url = BASE_URL + “/v3/accounts/” + OANDA_ACCOUNT_ID + “/pricing”
...
try:
url = BASE_URL + “/v3/accounts/” + OANDA_ACCOUNT_ID + “/orders”
...
try:
fmt = “{:.” + str(digits) + “f}”
url = BASE_URL + “/v3/accounts/” + OANDA_ACCOUNT_ID + “/trades/” + trade_id + “/orders”
requests.put(
url,
headers=HEADERS,
...
url = BASE_URL + “/v3/accounts/” + OANDA_ACCOUNT_ID + “/transactions”
r = requests.get(url, headers=HEADERS, params={“from”: today, “type”: “ORDER_FILL”}, timeout=10)
...
def main():
log.info(“OANDA PRO BOT v4.0 STARTED”)
log.info(“API KEY: “ + str(OANDA_API_KEY[:10]) + “…”)
log.info(“ACCOUNT: “ + str(OANDA_ACCOUNT_ID))
log.info(“DEMO: “ + str(DEMO))
...
while True:
    try:
        ...
        log.info(
            ...
            " Open:" + str(len(open_trades)) +
            " Trades:" + str(daily_trades) +
            " PnL:" + str(round(pnl, 2)) +
            " DD:" + str(round(drawdown, 1)) + "%"
        )

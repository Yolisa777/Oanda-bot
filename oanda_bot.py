...
if fe and se:
vals.append(fe - se)
if len(vals) < MACD_SIGNAL:
return None
sig = calc_ema(vals, MACD_SIGNAL)
...
def main():
log.info(“OANDA BOT STARTED - LIVE ACCOUNT”)
